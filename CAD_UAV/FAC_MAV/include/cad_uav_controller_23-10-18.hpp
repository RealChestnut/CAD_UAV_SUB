...
///// Original MoI /////
double Jxx = 0.71;//0.82;//1.17;//1.23;//6.75;
double Jyy = 0.56;//0.56;//0.71;//0.208;//1.23;//1.71;
double Jzz = 1.15;//1.40;//1.17; //1.50;//5.53;
/////////////////////////////
...
void wrench_allocation()
{
  ...
  // send for sub agent data from serial module
...
void PublishData()
{
  ...
  /////////////////////////////
  goal_dynamixel_position.publish(servo_msg_create(theta3_command,theta4_command, theta1_command,theta2_command,servo_90rot)); // desired theta 서브드론은 현재 wizard에서 id를 밀려써서 2칸씩 밀었음
