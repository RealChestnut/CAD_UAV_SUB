...
int main(int argc, char **argv){
    ...
    // ros::Subscriber parameter_sub = nh.subscribe("/update_params", queue_size, update_params_cb); // not use
    ...
    cv::Mat color(Size(1920,1080), CV_8UC3, (void*)color_frame.get_data(), cv::Mat::AUTO_STEP);
